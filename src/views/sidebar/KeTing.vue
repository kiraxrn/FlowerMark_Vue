...
export default {
  ...
  data() {
    ...
    useFallbackData(){
      return[
        { id: 301, name: '发财树盆栽', price: 78.0, image: 'https://images.unsplash.com/photo-1520763185298-1b434c919102?w=500&h=664&fit=crop' },
        { id: 302, name: '绿萝吊篮', price: 35.0, image: 'https://images.unsplash.com/photo-1563241527-3004b7be0ffd?w=500&h=664&fit=crop' },
        { id: 303, name: '龟背竹', price: 65.0, image: 'https://images.unsplash.com/photo-1582794543139-8ac9cb0f7b11?w=500&h=664&fit=crop' },
        { id: 304, name: '虎皮兰', price: 42.0, image: 'https://images.unsplash.com/photo-1594736797933-d0c64a0d9d43?w=500&h=664&fit=crop' },
        { id: 305, name: '白掌盆栽', price: 58.0, image: 'https://images.unsplash.com/photo-1578321272177-44a4a8e5c0d5?w=500&h=664&fit=crop' },
        { id: 306, name: '金钱树', price: 95.0, image: 'https://images.unsplash.com/photo-1578326457397-2a7b4c1a5c5b?w=500&h=664&fit=crop' },
      ]
    }
  }
}
